...
def create_task():
    ...
    print(tasks)
    return jsonify({"message": "Nova tarefa criada com sucesso.", "id": new_task.id}) #jsonify vem do flask que transforma o conteúdo de um dicionário em json ou xml. as normas da API REST exigem que retorne json/xml
